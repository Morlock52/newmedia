...
class WorkingMinimalMCP {
  constructor() {
    ...
    this.serverInfo = { name: 'working-minimal-mcp', version: '1.0.0' };
  }

  log(msg) {
    if (process.env.MCP_DEBUG === 'true') {
      console.error(`[working-minimal] ${new Date().toISOString()} ${msg}`);
    }
  }
  ...
  start() {
    console.error('[working-minimal] Starting...');
    ...
    console.error('[working-minimal] Ready');
  }
}
