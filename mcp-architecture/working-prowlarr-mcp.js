...
class WorkingMinimalMCP {
  constructor() {
    ...
    this.serverInfo = { name: 'prowlarr-mcp', version: '1.0.0' };
  }

  log(msg) {
    if (process.env.MCP_DEBUG === 'true') {
      console.error(`[prowlarr] ${new Date().toISOString()} ${msg}`);
    }
  }
  ...
  start() {
    console.error('[prowlarr] Starting...');
