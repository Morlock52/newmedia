...
class WorkingMinimalMCP {
  constructor() {
    ...
    this.serverInfo = { name: 'jellyfin-mcp', version: '1.0.0' };
  }

  log(msg) {
    if (process.env.MCP_DEBUG === 'true') {
      console.error(`[jellyfin] ${new Date().toISOString()} ${msg}`);
    }
  }
  ...
  start() {
    console.error('[jellyfin] Starting...');
