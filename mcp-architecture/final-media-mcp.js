...
class MediaServerMCP extends FinalFixMCPServer {
  constructor() {
    const tools = [
      {
        name: 'search_media',
    ...
    super('media-server-mcp', tools, resources);
  }

  async handleToolCall(name, args) {
    console.error(`[media-server] Tool call: ${name} with args: ${JSON.stringify(args)}`);
  ...
  async handleResourceRead(uri) {
    console.error(`[media-server] Resource read: ${uri}`);
